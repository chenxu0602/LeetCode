...
# 
# Return the integral coordinate where the network quality is maximum. If there
# are multiple coordinates with the same network quality, return the
# lexicographically minimum coordinate.
# 
# Note:
# 
# 
# A coordinate (x1, y1) is lexicographically smaller than (x2, y2) if either x1
